        ...
        <nav class="container mx-auto px-8">
            <ul class="flex justify-end space-x-8 py-3 text-sm">
                ...
                <li @mouseover="isAccountLinkHovered = true" class="relative cursor-pointer">
                    ...
                    <div v-if="isAccountLinkHovered" @mouseleave="isAccountLinkHovered = false"
                         class="absolute right-0 w-max h-max p-4 bg-white border-2 border-gray-300 mt-3 z-50">
                        <span class="text-base text-gray-500">Welcome to Aliexpress!</span>
                        <div class="flex space-x-2 py-2 border-b-2 border-gray-200">
                            <a href="/register"
                               class="bg-red-500 text-white py-2 px-8 text-center font-bold rounded-sm">Join</a>
                            <a href="/login" class="bg-red-100 text-red-500 py-2 px-8 text-center font-bold rounded-sm">Sign
                                in</a>
                        </div>
